...
if ((isset($_SESSION['controladorEnCurso'])) || (isset($_SESSION['controladorEnCurso']) && $_SESSION['controladorEnCurso'] == ($controladores["registro"]|| $controladores["login"]))) {//si la sesión esta iniciada, cargamos el controlador pasado
