    ...
    <section id="registro">
        <form class="descript" action= "<?php echo $_SERVER["PHP_SELF"] ?>" method= "POST">
            <div class="campos">
                ...
                <input id="codDep"  class="inputText" type="text" name="codDep"  readonly=""
                       value="<?php echo $_SESSION['codDepartamento'] ?>"> 
            ...
            <div class="campos">
                ...
                <input id="nDep" class="inputText" type="text" name="nDep" placeholder="Introduzca nombre del departamento"
                       value="<?php echo isset($_REQUEST["nDep"]) ? $aError["nDep"] ? null : $_REQUEST["nDep"] :  $oDepartamento->descDepartamento ?>">
            ...
            <div class="campos">
                ...
                <input id="vNegocio" class="inputText" type="text" name="vNegocio" placeholder="Inserte el volumen de negocio"
                       value="<?php echo isset($_REQUEST["vNegocio"]) ? $aError["vNegocio"] ? null : $_REQUEST["vNegocio"] : $oDepartamento->volumenDeNegocio ?>">
                <span  class='error'> <br> <?php echo isset($aError["vNegocio"]) ? $aError["vNegocio"] : null ?></span>
            </div>
            <div id="addep" class="botonSend">
                <input class="botonEnvio" type= "submit" value="Modificar Departamento" name="modificarDep">
