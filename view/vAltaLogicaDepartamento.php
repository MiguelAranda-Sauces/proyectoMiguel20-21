...
<article id="contenedor"> 
    <section id="delete">
        <form name="borrarDep"action= "<?php echo $_SERVER["PHP_SELF"] ?>" method= "POST">
            <label >¿Esta seguro de que quiere dar de alta el departamento con el codigo: <?php echo $_SESSION['codDepartamento'] ?>?</label>
            <div class="botonSend">
                <input class="botonEnvio" type= "submit" value="Alta Departamento" name="alta">
